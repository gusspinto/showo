...
export default function AIInterview() {
  ...
  async function generateAndSave(finalAnswers) {
    ...
    try {
      ...
      const formData = {
        name:            finalAnswers.name            || deriveNameFromDescription(description),
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.bg, color: C.text, fontFamily: 'var(--font-body)', display: 'flex', flexDirection: 'column' }} className="ai-interview-wrap">
      <Navbar />
      <style>{`
