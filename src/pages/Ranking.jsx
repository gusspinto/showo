  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: colors.bg, color: colors.text, fontFamily: 'var(--font-body)' }}>
      <style>{`
        ...
        .rank-top:hover { transform: translateY(-4px) scale(1.01) !important; }
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        padding: '24px 28px',
                        cursor: 'pointer',
                        boxShadow: `0 6px 28px ${t.color}18`,
                        display: 'flex', alignItems: 'center', gap: 20,
                      }}
                    >
                      {/* Award icon + rank label */}
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, flexShrink: 0, minWidth: 48 }}>
                        <RankIcon size={26} color={t.color} strokeWidth={2} style={{ filter: `drop-shadow(0 0 8px ${t.color}80)` }} />
                        <span style={{ fontSize: 11, fontWeight: 800, color: t.color, letterSpacing: '0.3px' }}>{t.label}</span>
                      </div>

                      {/* Score ring */}
                      <ScoreRingLg score={project.score} />

                      {/* Info */}
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', marginBottom: 6 }}>
                          <span style={{ fontSize: 18, fontWeight: 800, color: colors.text, letterSpacing: '-0.3px' }}>{project.name}</span>
                          {project.is_pap && (
                            <span style={{
                      ...
                      <span style={{ fontSize: 13, color: t.color, fontWeight: 700, flexShrink: 0, opacity: 0.85 }}>Ver →</span>
                    </div>
                  )
                })}
              </div>
