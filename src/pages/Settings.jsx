    ...
    <div style={{ minHeight: '100vh', background: C.bg, fontFamily: 'inherit' }}>
      ...
      <div className="page-content">
        ...
        <>
          ...
          {/* Danger zone */}
          <SectionCard title="Zona de perigo">
            <p style={{ color: C.muted, fontSize: 14, margin: '0 0 12px', lineHeight: 1.65 }}>Terminar sessão em todos os dispositivos.</p>
            <button onClick={async () => { await supabase.auth.signOut(); navigate('/') }}
              style={{ background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: 10, padding: '11px 24px', color: C.red, fontSize: 14, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', transition: 'background 0.15s', marginBottom: 20 }}
              onMouseEnter={e => e.currentTarget.style.background = 'rgba(239,68,68,0.14)'}
              onMouseLeave={e => e.currentTarget.style.background = 'rgba(239,68,68,0.08)'}>
              Terminar sessão
            </button>
