-- ============================================================
-- 118 — join_class passa a promover a conta a 'school'.
-- ------------------------------------------------------------
-- Havia dois caminhos para entrar numa turma e divergiram:
--   · register_institutional_student (083) — no registo com código:
--     valida o domínio da escola e faz UPDATE account_type = 'school'.
--   · join_class (091/117) — o modal "Entrar numa turma" na app:
--     EXIGIA account_type = 'school' mas nunca o definia. Só funcionava
--     para quem já tinha passado pelo primeiro caminho.
--
-- Entrar numa turma válida (com o código que o professor deu, e se a
-- turma estiver ligada a uma escola, com o email do domínio certo) é o
-- que torna a conta institucional. Deixa de haver o gate à entrada.
-- ============================================================
...
BEGIN
  ...
  -- Entrou numa turma → conta institucional.
