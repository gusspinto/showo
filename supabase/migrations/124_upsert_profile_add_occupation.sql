-- ============================================================================
-- 124_upsert_profile_add_occupation.sql — adiciona p_occupation ao
-- upsert_own_profile (Settings.jsx passa a poder editar "o que fazes",
-- o mesmo campo recolhido no registo da conta Individual — ver 123).
-- ============================================================================

drop function if exists public.upsert_own_profile(
